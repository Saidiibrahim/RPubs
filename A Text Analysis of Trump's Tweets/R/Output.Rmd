...
log2(# in Android+1Total #words Android+1# in iPhone+1Total #words iPhone+1)
log2⁡(# in Android+1Total #words Android+1# in iPhone+1Total #words iPhone+1)
...
The “ +1+1 ”, called [Laplace smoothing](https://en.wikipedia.org/wiki/Additive_smoothing), are to avoid dividing by zero and to put [more trust in common words](http://varianceexplained.org/r/empirical_bayes_baseball/).
```{r part_8}
...
nrc <- read_rds("~/Desktop/GitHub Repositories/RPubs/A Text Analysis of Trump's Tweets/datasets/nrc.rds")
